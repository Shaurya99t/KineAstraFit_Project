...
class UserProfile(Base):
    ...
    height = Column(Integer, nullable=True, default=170)
    goal = Column(String, nullable=False, default="fat loss")
    diet = Column(String, nullable=False, default="veg")
    activity_level = Column(String, nullable=True, default="moderate")
    fitness_level = Column(String, nullable=True, default="beginner")
    region = Column(String, nullable=True, default="india")
    target_weight = Column(Integer, nullable=True)
    workout_preference = Column(String, nullable=True, default="Push / Pull / Legs")
